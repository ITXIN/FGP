...
static const CGFloat CSToastBottomPadding       = 83.0;
...
static const CGFloat CSToastShowDuration        = 0.1;
static const CGFloat CSToastFadeDuration        = 0.8;

// shadow appearance
static const CGFloat CSToastShadowOpacity       = 0.4;
static const CGFloat CSToastShadowRadius        = 3.0;
static const CGSize  CSToastShadowOffset        = { 0.0, 1.0 };
...
- (void)showToast:(UIView *)toast duration:(CGFloat)interval position:(id)point {
    ...
    [UIView animateWithDuration:CSToastShowDuration
                          delay:0.0
